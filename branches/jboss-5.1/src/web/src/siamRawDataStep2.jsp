...
<%// First grab the query variables
            ...
            if ((convertToHex != null) && (convertToHex.compareTo("yes") == 0))
            ...
            if (deviceIDOK) {
                    ...
                    if (timeQueryBy.compareTo("hoursToEnd") == 0) {
                        ...
                        if ((dateTime != null) && (dateTime.length > 0)) {
                            ...
                            if (year != null) {
                                ...
                                if (yearInteger != null) {
                                    endCalendar.set(Calendar.YEAR, (yearInteger
                                        .intValue()));
                                }
                            }
                            if (month != null) {
                ...
                try {
                    sqlDSLocalHome = SQLDataStreamRawDataAccessUtil
                        .getLocalHome();
                } catch (Exception e) {}
                ...
                if (startCalendar != null) {
                    startTimestampSeconds = new Long(startCalendar
                        .getTimeInMillis() / 1000);
                }
                if (endCalendar != null) {
                    endTimestampSeconds = new Long(endCalendar
                        .getTimeInMillis() / 1000);
                }
                ...
                out.print("<div id=\"contentTitle\">Data Report for Device " + deviceID
                    + " sorted by ");
        ...
        out.println("<div id=\"content\">");
                ...
                if (htmlFormatBoolean) {
                    out
                        .println("<table style=\"background-color: white;\" cellpadding=\"1\" border=\"1\" cellspacing=\"1\"><tr>");
                } else {
                    out.println("<pre>");
                }
                ...
                if (showDateBoolean) {
                    ...
                    if (htmlFormatBoolean) {
                        out
                            .print("<th>SIAM Timestamp<br>converted to time/date ("
                                + chosenTimezone + ")</th>");
                    } else {
                        if (firstColumnYet)
                            out.print(outputDelimiter);
                ...
                if (displayDataBuffer) {
                    if (convertToHexBoolean) {
                        if (htmlFormatBoolean) {
                            out
                                .print("<th>Hex Representation of Data Buffer</th>");
                        } else {
                            if (firstColumnYet)
                                out.print(outputDelimiter);
                        ...
                        if (htmlFormatBoolean) {
                            out
                                .print("<th>String Representation of Data Buffer</th>");
                        } else {
                            if (firstColumnYet)
                                out.print(outputDelimiter);
                ...
                if (displaySecondDataBufferSize) {
                    ...
                    if (htmlFormatBoolean) {
                        out
                            .print("<th>Secondary Buffer<br>Size (# bytes)</th>");
                    } else {
                        if (firstColumnYet)
                            out.print(outputDelimiter);
                ...
                if (displaySecondDataBuffer) {
                    if (convertSecondToHexBoolean) {
                        if (htmlFormatBoolean) {
                            out
                                .print("<th>Hex Representation of Secondary Data Buffer</th>");
                        } else {
                            if (firstColumnYet)
                                out.print(outputDelimiter);
                            out
                                .print("Hex Representation of Secondary Data Buffer");
                        }
                        firstColumnYet = true;
                    } else {
                        if (htmlFormatBoolean) {
                            out
                                .print("<th>String Representation of Secondary Data Buffer</th>");
                        } else {
                            if (firstColumnYet)
                                out.print(outputDelimiter);
                            out
                                .print("String Representation of Secondary Data Buffer");
                        }
                        firstColumnYet = true;
                    }
                }
                    ...
                    if (values != null) {
                        ...
                        while (iterator.hasNext()) {
                            ...
                            if (htmlFormatBoolean) {
                                ...
                                if ((!orderByTimeBoolean) && (prevSeqNum > -1)
                                    && ((key.longValue() - prevSeqNum) > 1)) {
                            ...
                            if (showDateBoolean) {
                                ...
                                if (currentCalendar != null) {
                                    currentCalendar.setTimeInMillis(ssdsDP
                                        .systemTime());
                                    if (dateTimeConversionFormat
                                        .compareTo("oasis") == 0) {
                                        ...
                                        double second = (double) currentCalendar
                                            .get(Calendar.SECOND);
                                        double fracDay = hourOfDay + minute
                                            / 60.0 + second / 3600.0;
                            ...
                            if (displayParentID) {
                                if (htmlFormatBoolean) {
                                    out.print("<td>" + ssdsDP.getPlatformID()
                                        + "</td>");
                                } else {
                                    if (firstColumnYet)
                                        out.print(outputDelimiter);
                            ...
                            if (displayRecordType) {
                                if (htmlFormatBoolean) {
                                    out.print("<td>" + ssdsDP.getRecordType()
                                        + "</td>");
                                } else {
                                    if (firstColumnYet)
                                        out.print(outputDelimiter);
                    ...
                    if (ssdsDataPacket != null) {
                        ...
                        if (delimiterPattern != null) {
                            ...
                            try {
                                ...
                                out
                                    .println("<b>Could not compile data pattern</b>");
                            }
                            String firstByteArray = new String(ssdsDataPacket
                                .getDataBuffer());
                            ...
                            if ((columns != null) && (columns.length != 0)) {
                                ...
                                for (int columnIndex = 0; columnIndex < columns.length; columnIndex++) {
                                    ...
                                    try {
                                        ...
                                        if (b) {
                                            ...
                                            if (createdDouble)
                                                validColumns.add(new Integer(
                                                    columnIndex));
                                        }
                                    } catch (Exception ex) {
                                        out
                                            .println("<b>Could not extract data from text in column "
                                                + columnIndex + "</b>");
                                    }
                                }
                                ...
                                for (int xySeriesIndex = 0; xySeriesIndex < dataSeries.length; xySeriesIndex++) {
                                    ...
                                    if (minValues[xySeriesIndex] == maxValues[xySeriesIndex]) {
                                        out
                                            .println("<h3>Chart was not created because line would be flat with value of "
                                    ...
                                    if (range.getLowerBound() == range
                                        .getUpperBound()) {
                                        yAxis.setRange(range.getLowerBound()
                                            - Math.abs(range.getLowerBound())
                                            * 0.01, range.getUpperBound()
                                    ...
                                    JFreeChart chart = new JFreeChart("",
                                        JFreeChart.DEFAULT_TITLE_FONT, xyPlot,
                                        false);
                                    chart
                                    ...
                                    String filename = ServletUtilities
                                        .saveChartAsPNG(chart, 1024, 400, info,
                                            session);
                                    out.flush();
                                    out
                                        .println("<br><img src=\""

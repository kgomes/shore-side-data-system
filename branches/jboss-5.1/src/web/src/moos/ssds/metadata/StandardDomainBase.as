 ...
 * THE GENERATOR. INSTEAD, EDIT THE INHERITED CLASS (StandardDomain.as).
 */
...
package moos.ssds.metadata {
    ...
    [Bindable]
    public class StandardDomainBase implements IExternalizable, IMetadataObject, IDescription {

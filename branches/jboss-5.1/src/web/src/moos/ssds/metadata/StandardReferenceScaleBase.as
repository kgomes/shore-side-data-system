 ...
 * THE GENERATOR. INSTEAD, EDIT THE INHERITED CLASS (StandardReferenceScale.as).
 */
...
package moos.ssds.metadata {
    ...
    [Bindable]
    public class StandardReferenceScaleBase implements IExternalizable, IMetadataObject {

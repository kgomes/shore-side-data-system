 ...
 * THE GENERATOR. INSTEAD, EDIT THE INHERITED CLASS (DataContainerGroup.as).
 */
...
package moos.ssds.metadata {
    ...
    [Bindable]
    public class DataContainerGroupBase implements IExternalizable, IMetadataObject, IDescription {

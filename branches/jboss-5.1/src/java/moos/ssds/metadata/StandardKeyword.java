 ...
 * 
 * @stereotype role
 * @hibernate.class table="StandardKeyword"
 * @author : $Author: kgomes $
 * @version : $Revision: 1.1.2.9 $
 */
public class StandardKeyword implements IMetadataObject {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof StandardKeyword))
			return false;

		// Cast to StandardKeyword object
		final StandardKeyword that = (StandardKeyword) obj;

		// Now check missing business key (name)
	 ...
	 * 
	 * <pre>
	 * StandardKeyword newStandardKeyword = new StandardKeyword();
	 * 
	 * newStandardKeyword.setValuesFromStringRepresentation(
	 * 		&quot;StandardKeyword|name=CTD|description=CTD Types&quot;, &quot;|&quot;);
	 * </pre>
	 * 
	...
	/**
	 * This is the method to serialize a StandardKeyword to a custom serialized
	 * form
	 * 
	...
	protected Object clone() throws CloneNotSupportedException {
		// Create the clone
		StandardKeyword clone = new StandardKeyword();

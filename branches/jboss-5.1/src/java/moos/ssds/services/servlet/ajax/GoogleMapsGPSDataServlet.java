...
/**
 * @web.servlet name="GoogleMapsGPSData" display-name="Get GPS Data in Google
 *              Maps format"
 * @web.servlet-mapping url-pattern="/ajax/GoogleMapsGPSData"
 */
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (deviceID != null) {
            ...
            startCalendar.add(GregorianCalendar.HOUR, -1
                * numHoursBack.intValue());

            // Now grab the service handle

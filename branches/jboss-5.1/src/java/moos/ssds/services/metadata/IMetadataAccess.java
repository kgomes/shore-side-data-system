...
public interface IMetadataAccess {
     ...
     *            search for.
     * @return the <code>MetadataObject</code> that has the matching
     ...
     * 
     * @param id
     *            is a <code>java.lang.String</code> that will be converted to
     *            a <code>java.lang.Long</code> that is the identifier (at the
     *            persistence) layer of the <code>MetadataObject</code> to
     *            search for.
     * @return the <code>MetadataObject</code> that has the matching
     *         identifier (id). If no match was found, null is returned.
    ...
    /**
     * This method will return all instances of <code>MetadataObject</code>s
     * for the specific services it was called again.
     * 
    ...
    /**
     * This method inserts the <code>MetadataObject</code> into the
     * persistence of the system.
     * 
     * @param insertRecord
     *            is the <code>MetadataObject</code> that will be inserted
     *            into the persistence system

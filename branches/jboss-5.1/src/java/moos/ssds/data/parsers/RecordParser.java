 ...
 * that understand how to break up individual records into their corresponding
 * <code>RecordVariable</code>s.
 * </p>
 * <hr>
 * 
...
abstract public class RecordParser {
     ...
     */
    public RecordParser(RecordDescription recordDescription) {
     ...
     * <code>RecordVariables</code> as keys and their data as values TODO
     * 20030702 brian: Need to accomodate Strings as well as numbers in the
     * returned Map
     */
    public abstract Map parse(byte[] buffer) throws ParsingException;

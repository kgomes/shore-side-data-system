...
import moos.ssds.data.parsers.BinaryRecordParser;
 ...
 */
public class TestBinaryRecordParser extends TestCase {

    /**
     * Constructs a test case with the given name.
     */
    public TestBinaryRecordParser(String name) {
        super(name);
    }
    ...
    public void testParse1() {
        ...
        try {
            ...
            BinaryRecordParser brp = new BinaryRecordParser(rd);

            // Now parse the record
            Map recordMap = brp.parse(bebytes);
            ...
            // Create the BinaryRecordParser
            brp = new BinaryRecordParser(rd);

            // Now parse the record
            recordMap = brp.parse(lebytes);
     ...
     * A log4j logger
     */
    static Logger logger = Logger.getLogger(TestBinaryRecordParser.class);
}

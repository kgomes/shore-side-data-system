 ...
 * <code>TopicConnection</code> when the class was no longer used. However,
 * the garbage collector would call the finalize() method at seemingly random
 * times. Causing the program to cease. Moving the close() call out of the
 * finalize() method stopeed this problem.
 * </p>
 * <hr>
 * 

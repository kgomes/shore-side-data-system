...
public class SSDSGeoLocatedDevicePacket extends SSDSDevicePacket
    ...
    /**
     * @see moos.ssds.transmogrify.SSDSDevicePacket#SSDSDevicePacket(DevicePacket)
     * @param devicePacket
     */
    ...
    /**
     * @see moos.ssds.transmogrify.SSDSDevicePacket#SSDSDevicePacket(long, int)
     * @param deviceID
     * @param bufferLength
     */
    ...
    public String toString() {
        ...
        String stringToReturn = new String(
            "SSDSGeoLocatedDevicePacket:deviceID=" + this.sourceID()
                + ";sequenceNumber=" + this.sequenceNo() + ";packetType="
                + this.getPacketType() + ";metadataSequenceNumber="
                + this.getMetadataSequenceNumber() + ";dataDescriptionVersion="
                + this.getDataDescriptionVersion() + ";platformID="
                + this.getPlatformID() + ";recordType=" + this.getRecordType()
                + ";dataBuffer=" + dataBufferString + ";otherBuffer="
                + otherBufferString + ";latitude=" + this.latitude
                + ";longitude=" + this.longitude + ";depth=" + this.depth);

...
public class PacketFileToSQLServicePublisher {
    ...
    public PacketFileToSQLServicePublisher(String fullPathToInputFile,
        String deviceID) throws IOException, RemoteException, CreateException,
        NamingException, Exception, Throwable {
        ...
        try {
            ...
            logger.error("Throwable caught trying to get home "
        ...
        if (this.pi != null) {
            while (pi.hasMoreElements()) {
                ...
                if (this.packetSubmissionAccess != null) {
                    byte[] ssdsBytes = SSDSDevicePacket
                        .convertToByteArray(ssdsdp);
     ...
     * <li>The full path to the file (if file is to be read from). Don't
     * specify anything if SQL, the SQL server is specified in the

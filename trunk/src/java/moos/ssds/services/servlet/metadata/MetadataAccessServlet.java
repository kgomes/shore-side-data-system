 ...
 * @author kgomes
 * @version 1.0
 * @web.servlet name="MetadataAccessServlet" display-name="Servlet to interact
 *              with metadata services"
 * @web.servlet-mapping url-pattern="/MetadataAccessServlet/*"
 * @web.servlet-mapping url-pattern="*.MetadataAccessServlet"
 * @web.servlet-mapping url-pattern="/MetadataAccessServlet"
 */
                ...
                if (metadataClass == null) {
                    out.print(ServletFaultHandler.formatFaultMessage(
                        ...
                        "It looks like you were specifying an Access class, "
                            + "but the base class of " + metadataClassName
                    ...
                    out
                        .print(ServletFaultHandler
                            .formatFaultMessage(
                                ...
                                "This is for security measures", responseType));

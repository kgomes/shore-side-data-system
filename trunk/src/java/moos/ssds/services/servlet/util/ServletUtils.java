...
public class ServletUtils {
    ...
    public static String getMethodListing(Class classToExamine, String format) {
        ...
        for (int i = 0; i < classMethods.length; i++) {
            ...
            if ((format.equals(TEXT_FORMAT)) || (format.equals(STRING_FORMAT))) {
                ...
                methodSignatureStringBuffer.append(messageFormat.getBeginMethod());
            }
            methodSignatureStringBuffer
                .append("method=" + classMethods[i].getName());
            ...
            methodSignatureStringBuffer.append("&delimiter=XXX&responseType=text|string|(html)|xml");
            methodSignatureStringBuffer.append(messageFormat.getEndMethod());
            // Now stuff it in the tree map using the method name as key
            methodSignatureMap.put(classMethods[i].getName(),methodSignatureStringBuffer.toString());
        }
     ...
     * @return
     */
    public static EJBLocalObject getLocalDataAccessInterface(Class dataAccessClass) {
...
class AbstractMessageFormat{
    ...
    public String getMethodsTitle(){ return "";}
    //the beginning of a method listing
    public String getBeginMethod(){return "";}
    public String getEndMethod(){return "";}
    public String getFooter(){return "";}
}

class XmlFormat extends AbstractMessageFormat{
    public String getMethodsTitle() {return "<ssds:Methods>";}
    public String getBeginMethod() {return "<ssds:Method><![CDATA[";}
    public String getEndMethod() {return "]]></ssds:Method>";}
    public String getFooter() {return "</ssds:Methods>";}
}

class HtmlFormat extends AbstractMessageFormat{
    public String getMethodsTitle() {return "<br><b>Methods:</b><br><ol>";}
    public String getBeginMethod() {return "<li><pre>";}
    public String getEndMethod() {return "</pre></li>";}
    public String getFooter() {return "</ol>";}
}

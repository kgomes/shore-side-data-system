 ...
 * 
 * @stereotype thing
 * @hibernate.class table="StandardDomain"
 * @author : $Author: kgomes $
 * @version : $Revision: 1.1.2.10 $
 */
public class StandardDomain implements IMetadataObject, IDescription {
	 ...
	 * 
	 * <pre>
	 * StandardDomain newStandardDomain = new StandardDomain();
	 * 
	 * newStandardDomain.setValuesFromStringRepresentation(
	 * 		&quot;StandardDomain|name=CTD|description=CTD Types&quot;, &quot;|&quot;);
	 * </pre>
	 * 
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof StandardDomain))
			return false;

		// Cast to StandardDomain object
		final StandardDomain that = (StandardDomain) obj;
	...
	/**
	 * This is the method to serialize a StandardDomain to a custom serialized
	 * form
	 * 
	...
	protected Object clone() throws CloneNotSupportedException {
		// Create the clone
		StandardDomain clone = new StandardDomain();
	 ...
	 */
	static Logger logger = Logger.getLogger(StandardDomain.class);

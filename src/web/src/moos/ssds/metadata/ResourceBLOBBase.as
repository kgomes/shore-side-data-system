 ...
 * THE GENERATOR. INSTEAD, EDIT THE INHERITED CLASS (ResourceBLOB.as).
 */
...
package moos.ssds.metadata {
    ...
    [Bindable]
    public class ResourceBLOBBase implements IExternalizable, IMetadataObject, IDescription {

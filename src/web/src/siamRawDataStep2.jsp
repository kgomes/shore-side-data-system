...
<body id="body" style="-rave-layout: grid">
	...
	<%
		...
		logger.debug(" --> displayRecordType"
				+ request.getParameter("displayRecordType"));
		logger.debug(" --> displayPacketType"
				+ request.getParameter("displayPacketType"));
		logger.debug(" --> displayDataBuffer"
				+ request.getParameter("displayDataBuffer"));
		logger.debug(" --> showDataBufferSize"
				+ request.getParameter("showDataBufferSize"));
		logger.debug(" --> convertToHex"
				+ request.getParameter("convertToHex"));
		logger.debug(" --> convertTo" + request.getParameter("convertTo"));
		...
		logger.debug(" --> displaySizeOfSecondaryDataBuffer"
				+ request.getParameter("displaySizeOfSecondaryDataBuffer"));
		logger.debug(" --> timeQueryType"
				+ request.getParameter("timeQueryType"));
		logger.debug(" --> lastNumPackets"
		...
		logger.debug(" --> tryToGraph" + request.getParameter("tryToGraph"));
		logger.debug(" --> graphDelimiter"
				+ request.getParameter("graphDelimiter"));
		logger.debug(" --> htmlFormat" + request.getParameter("htmlFormat"));
		logger.debug(" --> outputDelimiter"

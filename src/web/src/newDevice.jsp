<%@ page import="java.io.*,java.util.*,moos.ssds.metadata.*,moos.ssds.services.metadata.*,javax.naming.*,javax.ejb.*" %>
...
if ((personAccessLocalHome != null) && (deviceAccessLocalHome != null) && (deviceTypeAccessLocalHome != null)) {
    ...
    if (results != null) {
        ...
        while (i.hasNext()) {
            ...
            personsInputBuffer.append("<option value=\"" + person.getId() + "\">" + person.getSurname() + ", " + person.getFirstname() + " (" + person.getEmail() + ")</option>");
        }
    }
    ...
    if (results != null) {
        ...
        while (i.hasNext()) {
            ...
            deviceTypeInputBuffer.append("<option value=\"" + deviceType.getId() + "\">" + deviceType.getName()  + " (" + deviceType.getDescription() + ")</option>");
        }
    }
} else {
...
<form name="newDeviceForm" method="post" action="addDevice.jsp">
  ...
  <tr>
      <td colspan="2"><div align="center"><strong><em>Enter the New Device Information</em></strong></div></td>
  </tr>
  <tr>

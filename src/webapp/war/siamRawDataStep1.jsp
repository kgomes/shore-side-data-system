                    ...
                    <form name="querySetup" action="siamRawDataStep2.jsp" class="form">
                        <center>
                            <table cellpadding="2" border="2" cellspacing="1">
                                <tr bgcolor="#CCCCCC"><td align="center" colspan="2"><b>Choose Device Or Enter Device ID:</b></td></tr>
                                <tr>
                                    <td align="center"><select name="deviceID"><%out.println(devicePickListString);%></select></td>
                                    <td align="center"><input type="text" name="deviceIDEntered" size="20"></input></td>
                                </tr>
                                <tr bgcolor="#CCCCCC">
                                    <td colspan="2" align="center"><b>Choose data to display in the results</b></td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="center">
                                        <table cellpadding="1" cellspacing="1" border="1">
                                            <tr>
                                                <td align="center">SIAM<br />Timestamp</td>
                                                <td align="center">Convert to<br />Time/Date</td>
                                                <td align="center">Packet<br />Sequence<br />Number</td>
                                                <td align="center">Parent ID</td>
                                                <td align="center">Record Type</td>
                                                <td align="center"><p>Packet Type<br />(Metadata,<br />Data,<br />Message)</p></td>
                                                <td align="center">Size of Data<br />Buffer (# bytes)</td>
                                                <td align="center">Data<br />Buffer</td>
                                                <td align="center">Size of<br />Secondary Data<br />Buffer (# bytes)</td>
                                                <td align="center">Secondary<br />Data Buffer</td>
                                            </tr>
                                            <tr>
                                                <td align="center"><input type="checkbox" name="displayTimestamp" value="true" checked="true" /></td>
                                                <td align="center"><input type="checkbox" name="showDate" value="true" checked="true" /></td>
                                                <td align="center"><input type="checkbox" name="displaySequenceNumber" value="true" checked="true" /></td>
                                                <td align="center"><input type="checkbox" name="displayParentID" value="true" /></td>
                                                <td align="center"><input type="checkbox" name="displayRecordType" value="true" /></td>
                                                <td align="center"><input type="checkbox" name="displayPacketType" value="true" /></td>
                                                <td align="center"><input type="checkbox" name="showDataBufferSize" value="true" /></td>
                                                <td align="center"><input type="checkbox" name="displayDataBuffer" value="true" checked="true" /></td>
                                                <td align="center"><input type="checkbox" name="displaySizeOfSecondaryDataBuffer" value="true" /></td>
                                                <td align="center"><input type="checkbox" name="displaySecondaryDataBuffer" value="true" /></td>
                                            </tr>
                                            <tr>
                                                <td colspan="10">
                                                    <center>
                                                        <b>Enter the RecordType if you want a specific one (leave empty if you want them all)</b>
                                                        <br />
                                                        <input type="text" size="5" name="recordType" />
                                                    </center>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr bgcolor="#CCCCCC"><td colspan="2" align="center"><b>Choose Display Options</b></td></tr>
                                <tr>
                                    <td width="50%"><b>Sort Results By:</b></td>
                                    <td><input type="radio" name="tsORseq" value="timestamp" checked="true">Timestamp</input><br />
                                    <input type="radio" name="tsORseq" value="sequenceNumber">Sequence Number</input></td>
                                </tr>
                                <tr>
                                    <td width="50%"><b>Choose Date Timezone and Format</b></td>
                                    <td>
                                        <input type="radio" name="timezone" value="gmt" checked="true">GMT</input> <br />
                                        <input type="radio" name="timezone" value="pst">PST</input><br />
                                        <select name="dateTimeConversionFormat">
                                            <option value="yyyy-MM-dd HH:mm:ss Z" selected="true">yyyy-MM-dd HH:mm:ss Z</option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" name="htmlFormat" value="yes" checked="true">Yes</input> <br />
                                        <input type="radio" name="htmlFormat" value="no">No</input> (<i>Output delimiter</i>)
                                        <select name="outputDelimiter">
                                ...
                                <tr>
                                    <td width="50%"><b>Convert Primary Data Buffer to:</b></td>
                                    <td>
                                        <input type="radio" name="convertTo" value="nothing" checked="true">Nothing</input><br />
                                        <input type="radio" name="convertTo" value="hex">Hex</input><br />
                                        <input type="radio" name="convertTo" value="imageTag">Image Tag</input>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="50%"><b>Convert Secondary Data Buffer to ASCII Hex?</b></td>
                                    <td>
                                        <input type="radio" name="convertSecondaryToHex" value="yes">Yes</input><br />
                                        <input type="radio" name="convertSecondaryToHex" value="no" checked="true">No</input>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="50%"><b>Attempt to Create Plots of Data?</b></td>
                                    <td>
                                        <input type="radio" name="tryToGraph" value="yes">Yes</input> (<i>Data buffer delimiter</i>)
                                        <select name="graphDelimiter">
                                ...
                                <tr>
                                    <td>
                                        <b>How do you want to select the timeframe?</b><br />
                                        <input type="radio" name="timeQueryType" value="lastNumPackets" checked="true">Last Number of Packets</input><br />
                                        <input type="radio" name="timeQueryType" value="startToHours" onclick="selectStartDateForward()">From <i>Start Time</i> forward (Use Hours Offset)</input><br />
                                        <input type="radio" name="timeQueryType" value="hoursToEnd" onclick="selectEndDateBack()">From <i>End Time</i> back (Use Hours Offset)</input><br />
                                        <input type="radio" name="timeQueryType" value="startToEnd" onclick="selectStartToEndDate()">Start Time to End Time</input>
                                    </td>
                                    <td>
                                        <b>Query Criteria (<font color="#FF3366">Times in GMT</font>)</b><br />
                                        <input type="text" size="20" name="lastNumPackets" value="10"></input><i>Number of Packets Back</i><br />
                                        <input type="text" size="20" name="startTime" value="<% out.println(defaultStartTime);%>"></input>
                                        <a name="startCalAnchor" href="javascript:startCal.popup();">
                                            <img src="images/cal.gif" width="16" height="16" border="0" alt="Click to select start time"></img>
                                        </a><i>Start Time</i><br />
                                        <input type="text" size="20" name="endTime" value="<% out.println(defaultEndTime);%>"></input>
                                        <a name="endCalAnchor" href="javascript:endCal.popup();">
                                            <img src="images/cal.gif" width="16" height="16" border="0" alt="Click to select end time"></img>
                                        </a><i>End Time</i><br />
                                        <input type="text" size="5" name="hoursOffset" value="24"></input> <i>Hours (From Start/End Times)</i>
                                    </td>
                                </tr>
                            </table>
                            <p></p>
                            <input type="submit" name="querySetupSubmit" value="Next -->" />
                        </center>
                    </form>

	...
	public void run() {
		...
		for (int i = 0; i < numberOfPackets; i++) {
			...
			pc.publishBytes(this.createByteArray(
					TransmogrifyMDB.DEVICE_PACKET_STREAM_ID_VERSION_ONE,
					TransmogrifyMDB.DEVICE_MESSAGE_PACKET_VERSION_VERSION_ONE,
					this.deviceID, currentDate.getTime(), i + 1, 0,
					this.parentID, 1,
					TransmogrifyMDB.SENSOR_DATA_PACKET_STREAM_ID_VERSION_ONE,
					TransmogrifyMDB.SENSOR_DATA_PACKET_VERSION_VERSION_ONE,

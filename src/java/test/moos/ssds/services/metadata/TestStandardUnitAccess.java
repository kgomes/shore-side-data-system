...
public class TestStandardUnitAccess extends TestAccessCase {
	...
	protected void setUp() {
		...
		try {
			...
			logger.error("RemoteException caught while creating standardUnitAccess interface: "
					+ e.getMessage());
		}
		...
		try {
			...
			logger.error("ClassCastException caught trying to create two StandardUnit objects: "
					+ cce.getMessage());
		}
	}
	...
	public void testFindBys() {
		...
		try {
			...
			logger.error("MetadataAccessException caught inserting standardUnits in find by test: "
					+ e.getMessage());
			assertTrue(
		...
		assertTrue("findAll should have standardUnitOne",
				allStandardUnits.contains(standardUnitOne));
		assertTrue("findAll should have standardUnitTwo",
				allStandardUnits.contains(standardUnitTwo));
		...
		assertTrue("findAll should have standardUnitOne",
				likeNameStandardUnits.contains(standardUnitOne));
		...
		assertTrue("StandardUnit ID one should be there: ",
				allIds.contains(standardUnitOneId));
		assertTrue("StandardUnit ID two should be there: ",
				allIds.contains(standardUnitTwoId));

		assertTrue("StandardUnit name one should be there: ",
				allNames.contains("StandardUnitOne"));
		assertTrue("StandardUnit name two should be there: ",
				allNames.contains("StandardUnitTwo"));

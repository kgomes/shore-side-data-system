...
public class TestStandardVariableAccess extends TestAccessCase {
	...
	public void testFindBys() {
		...
		assertTrue(
				...
				findByReferenceScaleStandardVariables
		...
		assertTrue("findByLikeReferenceScale should have standardVariableOne",
				likeReferenceScaleStandardVariables
						.contains(standardVariableOne));
		assertTrue(
		...
		assertTrue("StandardVariable referenece scale two should be there: ",
				allReferenceScales
						.contains("StandardVariable two reference scale"));
	...
	public void testStandardUnitRelationship() {
		...
		// OK, let's first insert the two standardVariables
		Long standardVariableOneId = null;
		...
		// OK now get them back and they should not have any StandardUnits
		StandardVariable persistentSVOne = null;
		try {
		...
		// Collection susOne = null;
		// Collection susTwo = null;
		// try {
		// susOne = standardVariableAccess
		// .findAssociatedStandardUnits(persistentSVOne);
		// susTwo = standardVariableAccess
		// .findAssociatedStandardUnits(persistentSVTwo);
		// } catch (RemoteException e) {
		// assertTrue("RemoteException caught trying to "
		// + "find the associated standardUnits:" + e.getMessage(),
		// false);
		// } catch (MetadataAccessException e) {
		// assertTrue("MetadataAccessException caught trying to "
		// + "find the associated standardUnits:" + e.getMessage(),
		// false);
		// }
		// // OK, they should be empty, but not null
		// assertNotNull("The associated standardUnits(One) should not be null",
		// susOne);
		// assertNotNull("The associated standardUnits(Two) should not be null",
		// susTwo);
		// assertTrue(
		// "The associated StandardUnits(One) collection should be empty",
		// susOne.size() == 0);
		// assertTrue(
		// "The associated StandardUntis(Two) collection should be empty",
		// susTwo.size() == 0);
		//
		// Now before adding standardUnits, I need to get the object with its
		// collection filled out
		try {
			persistentSVOne = (StandardVariable) standardVariableAccess
		...
		// // Now I should be able to query back and find
		// susOne = null;
		// susTwo = null;
		// try {
		// susOne = standardVariableAccess
		...
		// susTwo);
		// assertTrue(
		// "The associated StandardUnits(One) collection should have  two StandardUnits",
		// susOne.size() == 2);
		// assertTrue(
		// "The associated  StandardUntis(Two) collection should be empty",
		// susTwo.size() == 0);

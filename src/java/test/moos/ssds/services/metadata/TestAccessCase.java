...
//        superLogger.setLevel(Level.DEBUG);
//        superLogger.addAppender(new ConsoleAppender(new PatternLayout(
//            "%d %-5p [%c %M %L] %m%n")));

        // Grab a userGroup facade
        try {
     ...
     */
    private Map getMethodMapOfTestableGetters(Method[] methods) {
    ...
    protected void testEqualityOfAllGetters(Object object1, Object object2) {
        ...
        Map methods1Map = getMethodMapOfTestableGetters(methods);
        Map methods2Map = getMethodMapOfTestableGetters(methods2);
    ...
    protected void testUpdate(IMetadataObject metadataObject,
        HashMap methodsToUpdate, IMetadataAccessRemote access) {
        ...
        Map methodsMap = getMethodMapOfTestableGetters(methods);
        ...
        Object[] noargs = new Object[]{};
        for (Iterator iter = methodsMap.keySet().iterator(); iter.hasNext();) {
            String methodName = (String) iter.next();
            superLogger
        ...
        for (Iterator iter = methodsToUpdate.keySet().iterator(); iter
            .hasNext();) {
            ...
            superLogger
                .debug("Going to replace the old return value of method "
                    + getMethodName + "->(" + oldValues.get(getMethodName)
    ...
    static String PERSON_TWO_STRING_REP = "Person|" + "firstname=Jane|"
        + "surname=Doe|" + "organization=MBARI|" + "email=janedoe@mbari.org|"
    ...
    static String DATA_CONTAINER_ONE_STRING_REP = "DataContainer|"
        ...
        + "dodsAccessible=false|" + "minLatitude=36.6|" + "maxLatitude=36.805|"
    ...
    static String DATA_CONTAINER_TWO_STRING_REP = "DataContainer|"
        ...
        + "dodsAccessible=false|" + "minLatitude=6.0|" + "maxLatitude=45.0|"
        + "minLongitude=-255.34|" + "maxLongitude=-245.567|" + "minDepth=10.5|"
        + "maxDepth=10000.5";
    ...
    static String RECORD_VARIABLE_ONE_STRING_REP = "RecordVariable|"
        ...
        + "format=RecordVariableOne Format|" + "units=RecordVariableOne Units|"
        + "columnIndex=1|" + "validMin=-99.99|" + "validMax=99.99|"
    ...
    static String RECORD_VARIABLE_TWO_STRING_REP = "RecordVariable|"
        ...
        + "format=RecordVariableTwo Format|" + "units=RecordVariableTwo Units|"
        + "columnIndex=2|" + "validMin=-9.9|" + "validMax=9.9|"
        + "missingValue=999999999.99999|" + "accuracy=-.1|" + "displayMin=-10|"
        + "displayMax=10|" + "referenceScale=RecordVariableTwo ReferenceScale|"
    ...
    static String RECORD_VARIABLE_FIVE_STRING_REP = "RecordVariable|"
        ...
        + "validMin=-59.99|" + "validMax=59.99|" + "missingValue=599.99999|"
        + "accuracy=-5.1|" + "displayMin=-50|" + "displayMax=50|"
    ...
    static String RECORD_VARIABLE_SIX_STRING_REP = "RecordVariable|"
        ...
        + "format=RecordVariableSix Format|" + "units=RecordVariableSix Units|"
        + "columnIndex=6|" + "validMin=-6.99|" + "validMax=6.99|"
        + "missingValue=69.99999|" + "accuracy=-6.6|" + "displayMin=-600|"
        + "displayMax=600|"
    ...
    static String DATA_PRODUCER_ONE_STRING_REP = "DataProducer|"
        + "name=DataProducerOne|" + "description=DataProducerOne Description|"
        + "startDate=2003-05-05T16:11:44Z|" + "endDate=2004-02-01T08:38:19Z|";
    static DataProducer DATA_PRODUCER_TWO = null;
    static String DATA_PRODUCER_TWO_STRING_REP = "DataProducer|"
        + "name=DataProducerTwo|" + "description=DataProducerTwo Description|"
        + "startDate=2003-05-05T16:11:44Z|" + "endDate=2004-02-01T08:38:19Z|";

...
public class SubmitFiles {
    ...
    private static void usage() {
        ...
        ejbHome = getHome("moos/ssds/services/metadata/DataProducerAccess", namingUrl);
    ...
    private static void doDeployment(String deplUrl) throws DODSException {
        ...
        while (it.hasNext()) {
            ...
            if (depl.getOutputs() != null) {
                logger
                    .debug("Collecting output file urls and removing them fom depl object...");
                ...
                while (itO.hasNext()) {
                    ...
                    if (dfString != null) {
	                    ...
	                    try {
	                        addFiles(outputFiles, d, DataProducer.class.getMethod(
	                            "addOutput", partypes));
	                    } catch (SecurityException e) {
	                        // TODO Auto-generated catch block
	                        e.printStackTrace();
    ...
    private static void doProcessRun(Collection inputFiles,
        ...
        try {
            ...
            if (inputFiles != null) {
                ...
                addFiles(inputFiles, pr, DataProducer.class.getMethod(
                    "addInput", partypes));
            } else {
                logger
            ...
            if (outputFiles != null) {
                ...
                DataContainer df = addFiles(outputFiles, pr, DataProducer.class
                    .getMethod("addOutput", partypes));
    ...
    private static void doProcessRun(String inUrl, Collection outputFiles,
        ...
        if (outputFiles != null) {
            ...
            try {
                df = addFiles(outputFiles, pr, DataProducer.class.getMethod(
                    "addOutput", partypes));
            } catch (SecurityException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            ...
            if (updatePR) {
                ...
                try {
                    ...
                    if (id == null) {
                        ...
                        logger
                            .debug("disposePRMetadata(): null id returned from update(), inserting new ProcessRun.");
                    ...
                    // Go ahead and insert a new ProcessRun
                    logger
                        .debug("disposePRMetadata(): Exception while attempting update(pr), message = " + e.getMessage());
                    logger
                        .debug("disposePRMetadata(): Assuming that ProcessRun not yet in database, calling insert(pr)");
                    try {
                        id = processRunAccess.insert(pr);
    ...
    private static DataContainer addFiles(Collection files, DataProducer dp,
        ...
        while (it.hasNext()) {
            ...
            if (!"".equals(nextURL)) {
                ...
                if (url.isLocal()) {
                    if (verbose)
                        System.err.println("Assuming that the argument "
                            + nextURL + " is a file\n"
    ...
    private static DataContainer genSSDSDataContainer(DConnect url)
        ...
        String shortName = strUrl.substring(strUrl.lastIndexOf('/') + 1, strUrl
            .length());
        if (verbose) {

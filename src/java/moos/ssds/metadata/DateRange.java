 ...
 * <code>IDateRange</code> object, it will use the other object's dates.
 * Typical use is:
 * </p>
 * 
 * <pre>
...
public class DateRange implements Serializable, IDateRange {
     ...
     * <code>IDateRange</code> and sets this object to be acting as a proxy
     * for that object
     * 
     * @param iDateRange
    ...
    /**
     * This method sets the <code>IDateRange</code> that the object will act
     * on behalf of. If it is null, it will simply use it's own internal dates.
     * 
     * @param dateRange
     ...
     * @return <code>true</code> if the end of the <code>IDateRange</code>
     *         is before the given <code>Date</code>
     */
    ...
    /**
     * This method returns a <code>boolean</code> that indicates if the start
     * of the <code>IDateRange</code> is after the <code>Date</code> given
     * 
     * @return <code>true</code> if the startDate of the
     *         <code>IDateRange</code> occurs after the given
     *         <code>Date</code>.
     * @param date
     *            The date to compare
     */
     ...
     * <code>IDateRange</code> starts before the given <code>Date</code>,
     * but ends after it.
     * 
     * @param date
    ...
    /**
     * This method checks to see if the <code>IDateRange</code>'s time
     * interval is BEFORE, AFTER, or over (DURING) the given <code>Date</code>
     * 
     * @param date
     ...
     * <code>IDateRange</code>
     * 
     * @return a <code>long</code> that is the number of milliseconds covered
     *         by the <code>IDateRange</code>. If one of the start or end
     *         dates (or both) are missing, a 0 will be returned.
     */
     ...
     * <code>IDateRange</code>
     * 
     * @return a <code>long</code> that is the number of seconds covered by
     *         the <code>IDateRange</code>. If one of the start or end dates
     ...
     * 
     * @return a <code>float</code> that is the decimal number of hours
     *         covered by the <code>IDateRange</code>. If one of the start or
     *         end dates (or both) are missing, a 0 will be returned.
     */

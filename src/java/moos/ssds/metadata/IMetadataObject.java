 ...
 */
public interface IMetadataObject extends Serializable, Cloneable, Externalizable {
     ...
     * 
     * @return a <code>java.lang.Long</code> that is the persistence
     *         mechanisms unique identifier.
     */
    Long getId();
     ...
     * wise to do things like only add new attributes to the end of the string.</b>
     * 
     * @param delimiter
     ...
     *            replaced with the specified delimiter (if not null)
     * @param delimiter
     *            This is a <code>java.lang.String</code> that tells the
     *            method where the different fields are by specifying what
     *            separates them.
     ...
     * <code>java.lang.Object</code> and needs to be overridden due to the
     * fact that the <code>equals</code> method is overridden. The hashcode
     * should be derived from the business key that is talked about in the
     * description of the <code>equals</code> method. In short if two objects
     * pass the equals defined by the overridden equals method, they must return
     * the same exact hashCode.
     * 

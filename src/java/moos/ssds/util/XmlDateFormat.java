...
public final class XmlDateFormat implements Serializable {
     ...
     * @return a <code>Date</code> if parsing was successful, otherwise it
     *         will return null if not parsed. (This is consistent with how Java
     *         date parsers return their parsing results).
     */

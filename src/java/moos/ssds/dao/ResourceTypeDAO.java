...
public class ResourceTypeDAO extends MetadataDAO {
    ...
    public IMetadataObject findEquivalentPersistentObject(
        ...
        if (resourceType.getId() != null) {
            resourceTypeToReturn = (ResourceType) this.findById(resourceType
                .getId(), false);
        }
        if (resourceTypeToReturn == null) {
            Collection persistentResourceTypes = this.findByName(resourceType
                .getName(), true);
    ...
    public Collection findAllNames() throws MetadataAccessException {
        Collection resourceTypeNames = null;
    ...
    public Long makePersistent(IMetadataObject metadataObject)
        ...
        if (persistentResourceType != null) {
            ...
            if (this.updateDestinationObject(resourceType,
                ...
                addMessage(ssdsAdminEmailToAddress,
                    "A ResourceType was updated<br><b>Before</b><ul><li>"
                        ...
                        + persistentResourceType.toStringRepresentation("<li>")
                        + "</ul><br>");
            }
            ...
            if ((resourceType.getName() == null)
                ...
                try {
                    resourceType.setName("ResourceType_" + getUniqueNameSuffix());
                } catch (MetadataException e) {
                    logger
                        .error("MetadataException trying to set the name on the ResourceType");
                }
                addMessage(ssdsAdminEmailToAddress,
        ...
        if (!persistedBefore) {
            ...
            addMessage(ssdsAdminEmailToAddress,
                "A new ResourceType was created in SSDS:<br><ul><li>"
                    + resourceTypeToPersist.toStringRepresentation("<li>")
                    + "</ul><br>");
        }
    ...
    public void makeTransient(IMetadataObject metadataObject)
        ...
        if (persistentResourceType == null) {
            logger
                .debug("No matching resourceType could be found in the persistent store, "
                    + "no delete performed");
        } else {

...
public interface IMetadataDAO {
     ...
     * 
     * @return the Hibernate <code>Session</code> that a DAO is currently
     *         using for its persistence transactions.
     */
    public Session getSession();

    /**
     * This method set the Hibernate Session that will be used in the
     ...
     * @return the <code>IMetadataObject</code> that has the matching
     *         identifier (id). If no match was found, null is returned.
     ...
     * 
     * @return a <code>Collection</code> of <code>Long</code> that are the
     *         IDs of the <code>Person</code> object in the persistent store
     * @throws MetadataAccessException
     ...
     * associated <code>IMetadataObject</code>. This is equal to the number
     * of instances of that <code>IMetadataObject</code> in the persistent
     * store.
     * 
     * @return a count of all the <code>IMetadataObject</code>s that are in
     *         the persistent store that are associated with the DAO class.
     * @throws MetadataAccessException
     */
    ...
    /**
     * This method takes a <code>IMetadataObject</code> and makes it
     * persistent which could mean that it inserts a new one, or updates an
     * existing one. Whichever happens, the ID is returned.
     * 
     * @param metadataObject
     *            is the <code>IMetadataObject</code> that will be persisted.
     *            If no ID is specified, the business key will be used to try
     *            and find an object to update. If no equivalent is found, a new
     *            one will be saved.

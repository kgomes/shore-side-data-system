...
public class DeviceTypeDAO extends MetadataDAO {
	...
	public IMetadataObject findEquivalentPersistentObject(
		...
		if (returnFullObjectGraph)
			deviceTypeToReturn = (DeviceType) getRealObjectAndRelationships(deviceTypeToReturn);
	 ...
	 * are the IDs of all the deviceTypes that are in SSDS.
	 * 
	 * @return a <code>Collection</code> of <code>Long</code>s that are the IDs
	 *         of all deviceTypes in SSDS.
	 * @throws MetadataAccessException
